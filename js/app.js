...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image " src=${image}></img>
      ...
      <p>
      <small class="mx-2 fw-bold">Rating:${product.rating.rate}</small>
...
const displayDetails = data => {
  ...
  const div = document.createElement('div');
  div.innerHTML = `<div class="card mb-3 mx-auto" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="${data.image}" class="img-fluid rounded-start mt-4" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
...
//tap cancel to cancel selected item for details
const cancel = () => {
  document.getElementById('details').textContent = '';
}